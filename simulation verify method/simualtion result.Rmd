...
plot((gam_0), main = TeX("1st eignvec of ${A_1A_1^{T}}$"), ylab = TeX("$gamma$"))
plot((gam_1), main = TeX("1st eignvec of $(A_1A_1^{T} + A_2A_2^{T})$"), ylab = TeX("$gamma$"))
...
plot((U), main = TeX("True U"), ylab = "U")
points((n-5):n, U[(length(U) - 5):length(U)], col = "red")   
plot((gam_1), main = TeX("2nd eignvec of $A_1A_1^{T}$"), ylab = TeX("$gamma$"))
points((n-5):n, gam_1[(length(gam_1) - 5):length(gam_1)], col = "red")   
plot((gam_2), main = TeX("2nd eignvec of $(A_1A_1^{T} + A_2A_2^{T})$"), ylab = TeX("$gamma$"))
points((n-5):n, gam_2[(length(gam_2) - 5):length(gam_2)], col = "red")   
...
points((n-5):n, U[(length(U) - 5):length(U)], col = "red")   
plot((n-25):n, gam_1[(length(gam_1) - 25):length(gam_1)], main = TeX("2nd eignvec of $A_1A_1^{T}$"), ylab = TeX("$gamma$"), xlab = "Index")
points((n-5):n, gam_1[(length(gam_1) - 5):length(gam_1)], col = "red")   
plot((n-25):n, gam_2[(length(gam_2) - 25):length(gam_2)], main = TeX("2nd eignvec of $(A_1A_1^{T} + A_2A_2^{T})$"), ylab = TeX("$gamma$"), xlab = "Index")
points((n-5):n, gam_2[(length(gam_2) - 5):length(gam_2)], col = "red")   
...
plot((U), main = TeX("True U"), ylab = "U")
points((n-5):n, U[(length(U) - 5):length(U)], col = "red")   
plot((gam_1), main = TeX("2nd eignvec of $YY^{T}$"), ylab = TeX("$gamma$"))
points((n-5):n, gam_1[(length(gam_1) - 5):length(gam_1)], col = "red")   
plot((gam_2), main = TeX("2nd eignvec of $(YY^{T} + WW^{T})$"), ylab = TeX("$gamma$"))
points((n-5):n, gam_2[(length(gam_2) - 5):length(gam_2)], col = "red")   
plot((gam_4), main = TeX("2nd eignvec of ${\\sum}_{i=1}^{10}A_iA_i^{T}$"), ylab = TeX("$gamma$"))
points((n-5):n, gam_4[(length(gam_4) - 5):length(gam_4)], col = "red")   

plot((n-25):n, U[(length(U) - 25):length(U)], main = TeX("True U (Top 25)"), ylab = "U", xlab = "Index")
points((n-5):n, U[(length(U) - 5):length(U)], col = "red")   
plot((n-25):n, gam_1[(length(gam_1) - 25):length(gam_1)], main = TeX("2nd eignvec of $YY^{T}$"), ylab = TeX("$gamma$"), xlab = "Index")
points((n-5):n, gam_1[(length(gam_1) - 5):length(gam_1)], col = "red")   
plot((n-25):n, gam_2[(length(gam_2) - 25):length(gam_2)], main = TeX("2nd eignvec of $(YY^{T} + WW^{T})$"), ylab = TeX("$gamma$"), xlab = "Index")
points((n-5):n, gam_2[(length(gam_2) - 5):length(gam_2)], col = "red")   
plot((n-25):n, gam_4[(length(gam_4) - 25):length(gam_4)], main = TeX("2nd eignvec of ${\\sum}_{i=1}^{10}A_iA_i^{T}$"), ylab = TeX("$gamma$"), xlab = "Index")
points((n-5):n, gam_4[(length(gam_4) - 5):length(gam_4)], col = "red")  
```